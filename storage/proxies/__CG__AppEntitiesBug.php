 ...
 */
class Bug extends \App\Entities\Bug implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'description', 'status', 'engineer', 'reporter', 'products'];
        }
    ...
    public function closeBug()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'closeBug', []);

        return parent::closeBug();
    }
